...
// save Movie
    ...
    @PostMapping(value = "/save/{userId}", produces = MediaType.APPLICATION_JSON_VALUE)
        public ResponseEntity<AppResponse> save(@PathVariable String userId,
        ...
        BindingResult bindingResult) throws Exception 
        {
            ...
            User  user = userService.findByUserById(Integer.parseInt(userId));
            if(user == null){
...
// update movie 
    ...
    @PatchMapping(value = "/update/{userId}", produces = MediaType.APPLICATION_JSON_VALUE)
	    public ResponseEntity<AppResponse> update(@PathVariable String userId,
